...
public class Robot extends TimedRobot {
  ...
  public void robotPeriodic() {
    ...
    SmartDashboard.putNumber("MAX velo", Robot.st.getShooterVelo());
    //SmartDashboard.putNumber("")
    //SmartDashboard.putData("PID Controller", Shooter.getPIDController());

    SmartDashboard.putNumber("Limelight Distance", Robot.lm.distanceToTarget());
  }
