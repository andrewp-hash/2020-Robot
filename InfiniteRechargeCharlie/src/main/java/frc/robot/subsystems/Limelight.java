...
public class Limelight extends Subsystem {
  ...
  public double distanceToTarget(){
    System.out.println("Limelight Distance ft:" + (Config.goalHeight-Config.cameraHeight)/(Math.tan(Config.mountAngle+offsetAngle)));
    return Math.tan((Config.goalHeight-Config.cameraHeight)/(Math.tan(Config.mountAngle + offsetAngle)));
  }
